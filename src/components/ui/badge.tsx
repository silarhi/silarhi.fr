...
const variantStyles = {
    ...
    'outline-primary':
        'hover:border-primary hover:bg-primary/5 hover:text-primary text-gray-700 bg-surface border border-gray-300 transition-colors dark:border-border dark:text-foreground dark:hover:border-primary-light dark:hover:bg-primary-light/10',
}
