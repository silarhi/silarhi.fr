...
### Migration Symfony 4.4 → 6.2
Montée de version progressive vers Symfony 6.2 avec PHP 8.1, bénéficiant du JIT compiler et optimisations framework. Support long terme garanti jusqu'en 2025.
...
Exposition endpoints API sécurisés pour laboratoires dentaires avec documentation OpenAPI complète. Couche d'abstraction facilitant onboarding partenaires.
