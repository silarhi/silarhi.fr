...
published: true
industry: "Loisirs & Divertissement"
...
engagement:
  ...
  phases:
    - name: "Architecture & Conception"
      period: "Semaines 1-2"
      focus: "Conception architecture asynchrone AWS SQS, workers et consumers Symfony"
    - name: "Développement & Intégration"
      period: "Semaines 3-6"
      focus: "Implémentation workers, gestion erreurs, meta-queue, intégration Symfony"
    - name: "Tests & Déploiement"
      period: "Semaines 7-8"
      focus: "Tests charge, monitoring, déploiement production, documentation"
  deliverables:
