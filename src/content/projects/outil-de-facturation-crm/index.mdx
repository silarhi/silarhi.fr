...
engagement:
  ...
  phases:
    - name: "Analyse & Architecture"
      period: "Semaines 1-2"
      focus: "Analyse APIs HubSpot/Zoho, conception mapping données, architecture asynchrone"
    - name: "Développement Connecteur"
      period: "Semaines 3-6"
      focus: "Workers Symfony, intégrations APIs, workflow synchronisation, gestion erreurs"
    - name: "Tests & Déploiement"
      period: "Semaines 7-8"
      focus: "Tests intégration, containerisation Docker, monitoring, mise en production"
  deliverables:
